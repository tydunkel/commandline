        ...
        public void Lookup_allows_multi_instance()
        {
            ...
            var specProps = new[]
            {
                SpecificationProperty.Create(
                    new OptionSpecification(string.Empty, "name", false, string.Empty, Maybe.Nothing<int>(), Maybe.Nothing<int>(), '\0', Maybe.Nothing<object>(), string.Empty, string.Empty, new List<string>(), typeof(IEnumerable<string>), TargetType.Sequence),
